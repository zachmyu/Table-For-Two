...
def seed_reviews():
    1 = Review(user_id=1, venue_id=1, title="Lovely boat ride!", body="We had a great time on our 90 trip. The boat was great, the employees very friendly. We enjoyed a fun happy hour with friends cruising around the harbor", rating=5)
