...
def seed_venues():
    ...
    TheBodyLab = Venue(creator_id=1, name="The Body Lab",
                       ...
                       image_url="https://img.grouponcdn.com/deal/3Dm1LzKUsAtP1RfyBQW7jnrPkBjY/3D-700x420/v1/c870x524.webp", phone_number="(714) 516-8844",
    ...
    Bike2thebeat = Venue(creator_id=1, name="Bike2thebeat",
                         ...
                         image_url="https://img.grouponcdn.com/bynder/4MNMSftT5PqdsX3EWddvfL7JdhVe/4M-2048x1229/v1/c870x524.webp", phone_number="(949) 783-9181",
                         address="2779 El Camino Real",
                         city="Tustin", state="CA",
                         zipcode=92782,
                         operation_hours="5:30 AM–8:00 PM",latitude=33.6201,
                            longitude=117.9256)
    ...
    NatureSpaMassage = Venue(creator_id=2, name="Nature Spa & Massage",
                             ...
                             operation_hours="10:00 AM–8:00 PM",latitude=33.6201,
                            longitude=117.9256)
    DEFYTrampolinePark = Venue(creator_id=3, name="DEFY Trampoline Park",
                               ...
                               operation_hours="9:00 AM-9:00 PM",latitude=33.6201,
                            longitude=117.9256)
    PaddleBoardNewportBeach = Venue(creator_id=3, name="Paddle Board Newport Beach",
                                    ...
                                    city="Newport Beach", state="CA", zipcode=92663,
                                    operation_hours="10:00 AM–6:00 PM",latitude=33.6201,
                            longitude=117.9256)
    OakMountainWinery = Venue(creator_id=4, name="Oak Mountain Winery",
                              ...
                              operation_hours="11: 30 AM–2: 00 PM",latitude=33.6201,
                            longitude=117.9256)
    TheOfficialSAWEscape = Venue(creator_id=4, name="The Official SAW Escape",
                                 ...
                                 operation_hours="5:00 PM–11:00 PM",latitude=33.6201,
                            longitude=117.9256)
    LakehouseHotel = Venue(creator_id=5, name="Lakehouse Hotel & Resort",
                           ...
                           image_url="https://img.grouponcdn.com/deal/ntrmjUgGSGgBQmnGjto3/Y5-960x576/v1/c870x524.webp", phone_number="(877) 526-2671",
                           address="1025 La Bonita Dr",
                           city="San Marcos", state="CA",
                           zipcode=92078,
                           operation_hours="Open 24 Hours",latitude=33.6201,
                            longitude=117.9256)
    IndianWellsResortHotel = Venue(creator_id=5, name="Indian Wells Resort Hotel",
                                   ...
                                   operation_hours="6:30 AM–10:00 PM",latitude=33.6201,
                            longitude=117.9256)
    ...
    UncorkedTours = Venue(creator_id=7, name="Uncorked Tours",
                          ...
                          image_url="https://img.grouponcdn.com/deal/m6Sfa9z3yXtV3KpwrCAw/A8-2794x1676/v1/c870x524.webp", phone_number="(888) 400-7641",
                          address="34225 Rancho California Road",
                          city="Temecula", state="CA",
                          zipcode=92591,
                          operation_hours="10:30 AM–6:30 PM",latitude=33.6201,
                            longitude=117.9256)
    ConroeTaxidermyTours = Venue(creator_id=8, name="Conroe Taxidermy Tours",
                                 ...
                                 operation_hours="8: 00 AM–5: 00 PM",latitude=33.6201,
                            longitude=117.9256)
    PerfectDayPicnics = Venue(creator_id=8, name="Perfect Day Picnics",
                              ...
                              operation_hours="9: 00 AM-8: 00 PM",latitude=33.6201,
                            longitude=117.9256)
    ZombieScavengers = Venue(creator_id=9, name="Zombie Scavengers",
                             ...
                             operation_hours="11:00 AM–5:00 PM",latitude=33.6201,
                            longitude=117.9256)
    GhostTourBoston = Venue(creator_id=9, name="Death and Dying Ghost Tour in Boston",
                            ...
                            image_url="https://img.grouponcdn.com/pwa_test/ozJgQPXx5trGZiwcGoVdRJqkWQx/oz-669x446/v1/c870x524.webp", phone_number="(855) 999-9026",
                            address="24 Beacon St",
                            city="Boston", state="MA", zipcode="02133",
                            operation_hours="9:00 PM-10:30 PM",latitude=33.6201,
                            longitude=117.9256)
    PaintingVino = Venue(creator_id=10, name="Painting & Vino",
                         ...
                         image_url="https://img.grouponcdn.com/deal/3Y4a1fXFYzuhRoHbbgGVmMiAM7Zs/3Y-700x420/v1/c870x524.webp", phone_number="(855) 410-8330",
                         address="317 S Broadway",
                         city="Los Angeles", state="CA",
                         zipcode=90013,
                         operation_hours="9:00 AM-10:30 PM",latitude=33.6201,
                            longitude=117.9256)
    DallasTandemSkydiving = Venue(creator_id=10, name="Dallas Tandem Skydiving",
                                  ...
                                  operation_hours="6: 30 AM-8: 00 PM",latitude=33.6201,
                            longitude=117.9256)
    TheSecretChambers = Venue(creator_id=11, name="The Secret Chambers",
                              ...
                              operation_hours="2:30 PM–10:00 PM",latitude=33.6201,
                            longitude=117.9256)
    CombatPaintballPark = Venue(creator_id=11, name="Combat Paintball Park",
                                ...
                                operation_hours="9:00 AM–4:00 PM",latitude=33.6201,
                            longitude=117.9256)
    GrandCanyonHelicopterTours = Venue(creator_id=12, name="Grand Canyon Helicopter Tours",
                                       ...
                                       operation_hours="7:00 AM–10:00 PM",latitude=33.6201,
                            longitude=117.9256)
    SunBuggyFunRentals = Venue(creator_id=12, name="SunBuggy Fun Rentals",
                               ...
                               operation_hours="7:00 AM–7:00 PM",latitude=33.6201,
                            longitude=117.9256)
    CrazyDash = Venue(creator_id=13, name="Crazy Dash",
                      ...
                      image_url="https://img.grouponcdn.com/deal/3xGcA45T789r5AKRZGkG9CVorWsh/3x-700x420/v1/c870x524.webp", phone_number="(843) 256-6747",
